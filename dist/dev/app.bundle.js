...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(133) ], __WEBPACK_AMD_DEFINE_RESULT__ = function() {
	"use strict";
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
	...
	__webpack_require__(88) // jQuery.param
...
Object.defineProperty(exports, "__esModule", { value: true });
var DateUtility_1 = __webpack_require__(99);
...
Object.defineProperty(exports, "__esModule", { value: true });
var ProjectModel_1 = __webpack_require__(89);
var EventUtility_service_1 = __webpack_require__(53);
var core_1 = __webpack_require__(4);
var ProjectsDataAccess_service_1 = __webpack_require__(101);
...
Object.defineProperty(exports, "__esModule", { value: true });
var baseUrl_1 = __webpack_require__(102);
...
Object.defineProperty(exports, "__esModule", { value: true });
var TypeModel_1 = __webpack_require__(172);
var StatusModel_1 = __webpack_require__(171);
var PhaseModel_1 = __webpack_require__(170);
var EventUtility_service_1 = __webpack_require__(53);
var ProjectsDataAccess_service_1 = __webpack_require__(101);
var ProjectStatusesDataAccess_service_1 = __webpack_require__(175);
var ProjectTypesDataAccess_service_1 = __webpack_require__(176);
var ProjectPhasesDataAccess_service_1 = __webpack_require__(177);
var ProjectModel_1 = __webpack_require__(89);
...
var GridUtility = /** @class */ (function () {
    ...
    GridUtility.prototype.SortCommand = function (ColumnName) {
    ...
    GridUtility.prototype.SetNumberOfItems = function (NumberOfItems) {
    ...
    GridUtility.prototype.Offset = function (input) {
        if (input) {
            return input.slice(this.currentPage * this.ItemsPerPage);
        }
    };
    GridUtility.prototype.NumberOfPages = function () {
        return Math.ceil(this.numItems / this.ItemsPerPage);
    };
    GridUtility.prototype.PageNumbers = function () {
        var response = [];
    ...
    GridUtility.prototype.CanExecuteFirstCommand = function () {
    ...
    GridUtility.prototype.FirstCommand = function () {
        this.currentPage = 0;
        this.minTabShown = 0;
        if (this.numItems > 9) {
            this.maxTabShown = 9;
    ...
    GridUtility.prototype.CanExecutePrevCommand = function () {
        return this.NumberOfPages() > 1 && this.currentPage > 0;
    };
    GridUtility.prototype.PrevCommand = function () {
    ...
    GridUtility.prototype.CanExecutePageCommand = function (PageNumber) {
        return this.NumberOfPages() > 1 && this.currentPage != PageNumber && PageNumber >= 0 && PageNumber < this.NumberOfPages();
    };
    GridUtility.prototype.PageCommand = function (PageNumber) {
        if (this.CanExecutePageCommand(PageNumber)) {
            this.currentPage = PageNumber;
        }
    };
    GridUtility.prototype.CanExecuteNextCommand = function () {
        return this.NumberOfPages() > 1 && this.currentPage < (this.NumberOfPages() - 1);
    };
    GridUtility.prototype.NextCommand = function () {
    ...
    GridUtility.prototype.CanExecuteLeftEllipseCommand = function () {
        return this.NumberOfPages() > 9 && this.currentPage > 9;
    };
    GridUtility.prototype.LeftEllipseCommand = function () {
    ...
    GridUtility.prototype.CanExecuteRightEllipseCommand = function () {
        return this.NumberOfPages() > 1 && this.currentPage < (this.NumberOfPages() - 10);
    };
    GridUtility.prototype.RightEllipseCommand = function () {
    ...
    GridUtility.prototype.GetMinTab = function () {
        return this.minTabShown;
    };
    GridUtility.prototype.CanExecuteLastCommand = function () {
        return this.NumberOfPages() > 1 && this.currentPage < (this.NumberOfPages() - 1);
    };
    GridUtility.prototype.LastCommand = function () {
...
exports.GridUtility = GridUtility;
...
var PageQuantityUtility = /** @class */ (function () {
    ...
    PageQuantityUtility.prototype.GetDefaultPageQuantity = function (DefaultSelectedValue) {
    ...
    return PageQuantityUtility;
}());
exports.PageQuantityUtility = PageQuantityUtility;
...
Object.defineProperty(exports, "__esModule", { value: true });
var ProjectTrackerDetailRecordViewModel_service_1 = __webpack_require__(103);
var core_1 = __webpack_require__(4);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(4);
var ProjectTrackerListViewModel_service_1 = __webpack_require__(100);
var EventUtility_service_1 = __webpack_require__(53);
var GridUtility_service_1 = __webpack_require__(173);
var PageQuantityUtility_service_1 = __webpack_require__(174);
var ProjectTrackerAdminViewModel_service_1 = __webpack_require__(210);
var ProjectTrackerListViewModel_service_2 = __webpack_require__(100);
var ProjectTrackerDetailViewModel_service_1 = __webpack_require__(178);
var ProjectTrackerDetailRecordViewModel_service_1 = __webpack_require__(103);
var ProjectsDataAccess_service_1 = __webpack_require__(101);
var ProjectStatusesDataAccess_service_1 = __webpack_require__(175);
var ProjectTypesDataAccess_service_1 = __webpack_require__(176);
var ProjectPhasesDataAccess_service_1 = __webpack_require__(177);
var PagerUtility_service_1 = __webpack_require__(302);
    ...
    ProjectTrackerComponent = __decorate([
        core_1.Component({
            ...
            providers: [
                ...
                PagerUtility_service_1.PagerUtility
            ]
        }),
        ...
        __metadata("design:paramtypes", [Object, Object, Object, Object, PagerUtility_service_1.PagerUtility])
...
var static_1 = __webpack_require__(130);
var AppModule_1 = __webpack_require__(300);
var EventUtility_service_1 = __webpack_require__(53);
var GridUtility_service_1 = __webpack_require__(173);
var PageQuantityUtility_service_1 = __webpack_require__(174);
var ProjectTrackerAdminViewModel_service_1 = __webpack_require__(210);
...
var ProjectStatusesDataAccess_service_1 = __webpack_require__(175);
var ProjectPhasesDataAccess_service_1 = __webpack_require__(177);
var ProjectTracker_component_1 = __webpack_require__(209);
...
var forms_1 = __webpack_require__(208);
var http_1 = __webpack_require__(52);
var app_component_1 = __webpack_require__(301);
var EventUtility_service_1 = __webpack_require__(53);
var GridUtility_service_1 = __webpack_require__(173);
var PageQuantityUtility_service_1 = __webpack_require__(174);
var ProjectTracker_component_1 = __webpack_require__(209);
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            providers: [
                ...
                GridUtility_service_1.GridUtility,
                PageQuantityUtility_service_1.PageQuantityUtility
            ],
            bootstrap: [
                app_component_1.AppComponent
            ],
...
Object.defineProperty(exports, "__esModule", { value: true });
var PagerUtility = /** @class */ (function () {
    function PagerUtility() {
    }
    PagerUtility.prototype.getPager = function (totalItems, currentPage, pageSize) {
...
exports.PagerUtility = PagerUtility;
